...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Tambah Data Pencairan</h3>
        </div>
        <div class="section-body">
            <h2 class="section-title">Tambah Data Pencairan</h2>
            <p class="section-lead">***</p>
            <div class="card">
                <div class="card-body">
                    <form class="m-1" action="{{ route('pencairan.store') }}" method="POST" enctype="multipart/form-data">
                        @if ($errors->any())
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control cek_avail" name="year" id="year" required>
                                        @foreach ($years as $year)
                                            <option value="{{ $year->id }}" @if (old('year') == $year->id) selected @endif>
                                                {{ $year->year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control cek_avail" name="triwulan" id="triwulan" required>
                                        <option value="1" @if (old('triwulan') == 1) selected @endif>Pertama</option>
                                        <option value="2" @if (old('triwulan') == 2) selected @endif>Kedua</option>
                                        <option value="3" @if (old('triwulan') == 3) selected @endif>Ketiga</option>
                                        <option value="4" @if (old('triwulan') == 4) selected @endif>Keempat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="ket" id="ket" cols="30" rows="10"
                                        class="form-control form-avail">{{ old('ket') }}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control form-avail" name="tgl_pencairan"
                                        value="{{ old('tgl_pencairan') }}" id="tgl_pencairan" required>
                                </div>
                            </div>
                        </div>
